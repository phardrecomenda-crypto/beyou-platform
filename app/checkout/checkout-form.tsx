  ...
  return <main className="checkout-page">
    ...
    <div className="checkout-shell">
      <form action={submit} className="checkout-content">
        ...
        <button className="checkout-submit" type="submit" disabled={busy || Boolean(payment)}>{busy ? "Processando pagamento..." : payment ? "Pagamento enviado" : paymentMethod === "PIX" ? "Gerar Pix" : "Pagar com cartão"}</button>
      </form>
